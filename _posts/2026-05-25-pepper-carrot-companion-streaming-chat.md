...
And the retrieved half stays **spoiler-bounded**: on page 3 it can reach pages 1-2, never page 4 and beyond. Future pages simply aren't in the candidate set, and the boundary from [Post 9]({% post_url 2026-05-25-pepper-carrot-companion-spoiler-safe-rag %}) is still doing its job underneath the stream.
